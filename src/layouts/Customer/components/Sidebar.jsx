...
const menuItems = [
  {
    ...
    path: "/Customer/pages/dashboard",
  },
  {
    text: "Appointments",
    icon: <CalendarDays size={20} />,
    path: "/Customer/pages/appointments",
  },
  {
    text: "Medical Records",
    icon: <FileHeart size={20} />,
    path: "/Customer/pages/medicalrecords",
  },
  {
    text: "Payments",
    icon: <CreditCard size={20} />,
    path: "/Customer/pages/payments",
  },
  {
    text: "Notification",
    icon: <Bell size={20} />,
    path: "/Customer/pages/notification",
  },
  // {
  //   text: "Loyality & Feedback",
  //   icon: <Star size={20} />,
  //   path: "/Customer/pages/loyality&feedback",
  // },
  {
    text: "AI Assistant",
    icon: <Brain size={20} />,
    path: "/Customer/pages/aiassistant",
  },
  {
    text: "Setting",
    icon: <Settings size={20} />,
    path: "/Customer/pages/setting",
  },
];
