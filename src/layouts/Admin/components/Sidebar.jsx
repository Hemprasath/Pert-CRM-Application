...
const menuItems = [
  ...
  },
  {
    ...
    path: "/Admin/pages/paymentsInvoices",
  },
  // {
  //   text: "Marketing Tools",
  //   icon: <Megaphone size={20} />,
  //   path: "/Admin/pages/marketingTools",
  // },
  // {
  //   text: "Analytics / Reports",
  //   icon: <BarChart3 size={20} />,
  //   path: "/Admin/pages/analyticsReports",
  // },
  {
    text: "Setting",
    icon: <Settings size={20} />,
    path: "/Admin/pages/systemSettings",
  },
];
