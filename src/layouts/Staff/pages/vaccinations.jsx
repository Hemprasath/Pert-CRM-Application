...
function Vaccinations() {
  ...
  const [appointments, setAppointments] = useState(dummyVaccinations);
          ...
          <Table>
            <TableHead>
              <TableRow sx={{ background: "#E0F2FE" }}>
                ...
                <TableCell sx={{ fontWeight: 700 }}>Pet Vaccination</TableCell>
                        ...
                        sx={{
                          ...
                          backgroundColor:
                            a.status === "Pending"
                              ...
                              : a.status === "Completed"
                              ? "#2196F3" // Blue
                              : "#757575", // Gray for unknown / fallback
                        }}
                      />
            ...
            <DialogContent sx={{ p: 4, background: "#ffffff" }}>
              ...
              >
                ...
                {viewPet.vaccinations && viewPet.vaccinations.length > 0 ? (
                  viewPet.vaccinations.map((v, index) => (
                    <Box
                      key={index}
                      mb={1}
                    ...
                    >
                      <Typography>
                        <strong>Vaccine:</strong> {v.name}
                      </Typography>
                      <Typography>
                        <strong>Date:</strong> {v.date}
                      </Typography>
                      <Typography>
                        <strong>Next Due:</strong> {v.nextDue}
                      </Typography>
                    </Box>
                  ))
                ) : (
